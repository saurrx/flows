...
const WorkflowEditor = ({ params }: WorkflowPageProps) => {
  ...
  return (
    <div className="flex h-dvh w-full flex-col overflow-hidden">
      ...
      {!isMobile && (
        <div
          className="pointer-events-auto absolute inset-y-0 right-0 z-20 border-l border-white/10 bg-black/20 backdrop-blur-xl transition-transform duration-300 ease-out"
          style={{
            width: `${panelWidth}%`,
            transform:
