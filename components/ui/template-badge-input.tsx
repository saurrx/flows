...
export function TemplateBadgeInput({
  ...
  return (
    <>
      <div
        className={cn(
          "flex min-h-9 w-full rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm shadow-sm transition-all backdrop-blur-sm hover:bg-white/10 hover:border-white/20 focus-within:outline-none focus-within:ring-1 focus-within:ring-primary/20 focus-within:border-primary/50",
